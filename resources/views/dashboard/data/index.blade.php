...
<div class="container-fluid">
        <div class="row">
            ...
            <div class="container">
            <h1>User List</h1>
            <h7> Download Following data in to Excel Files By <a href="{{ route('users.excel') }}" class="">
             Click Here!
        </a></h7>
        <br>
        <h7> Download Following data in to PDF Files By <a href="{{ route('users.pdf') }}" class="">
             Click Here!
        </a></h7>
